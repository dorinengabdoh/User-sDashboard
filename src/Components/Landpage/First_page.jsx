    ...
    <>
          <div class="bg-white p-8 rounded shadow-md w-full md:w-2/3 lg:w-1/2 xl:w-1/3">
            ...
            <div class="flex justify-center">
              <button class=" hover:bg-blue-200 text-white hover:bg-blue-000 font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline-blue active:bg-blue-800">
